...
const FoodCard = ({id , name, price, desc, img , rating , handleToast}) => {
  ...
  return (
    <div className=' font-bold w-[250px]   p-5 flex flex-col rounded-lg  gap-2' id='dishes'>
           <img className='w-auto h-[130px] hover:scale-110  rounded-md cursor-grab transition-all duration-500 ease-in-out '  src={img} alt="" />
